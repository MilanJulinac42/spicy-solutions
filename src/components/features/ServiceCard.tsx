...
export function ServiceCard({ icon, title, description }: ServiceCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group relative p-6 md:p-8 rounded-2xl bg-surface-secondary border border-border-default hover:border-spicy-400/50 transition-all duration-300 hover:shadow-lg hover:shadow-spicy-400/10"
    >
      ...
      <div className="absolute inset-0 rounded-2xl bg-surface-secondary" />
